...
import 'package:permission_handler/permission_handler.dart'
    as ph; // Alias 'permission_handler'
import 'package:location/location.dart' as loc; // Alias 'location'
import 'package:detect_fake_location/detect_fake_location.dart'; // Plugin detect_fake_location
...
class PermissionProvider with ChangeNotifier {
  ...
  Future<void> _checkMockLocation() async {
    try {
      final bool isMock = await DetectFakeLocation()
          .detectFakeLocation(); // Menggunakan metode detect dari plugin
