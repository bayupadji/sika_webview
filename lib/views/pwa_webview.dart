        ...
        body: SafeArea(
          child: InAppWebView(
            ...
            initialSettings: InAppWebViewSettings(
              ...
              // Tetap aktifkan agar navigator.geolocation tersedia di JS —
              // permission di-auto-approve via onGeolocationPermissionsShowPrompt
              geolocationEnabled: true,
              disableDefaultErrorPage: true,
              networkAvailable: true,
              alwaysBounceVertical: false,
              isInspectable: kDebugMode, // aktifkan inspect hanya di debug
            ...
            initialUserScripts: UnmodifiableListView<UserScript>([
              UserScript(
                source: _geolocationQueueScript,
